...
!
 ...
 real,    allocatable :: fxyz_ptmass(:,:),fxyz_ptmass_sinksink(:,:),fsink_old(:,:),fsinkgas_slow(:,:),fgasink_slow(:,:)
...
subroutine allocate_part
 ...
 call allocate_array('fsinkgas_slow', fsinkgas_slow, 4, maxptmass)
 call allocate_array('fgassink_slow', fgasink_slow, 3,maxp)
...
subroutine deallocate_part
 ...
 if (allocated(fsinkgas_slow)) deallocate(fsinkgas_slow)
 if (allocated(fgasink_slow)) deallocate(fgasink_slow)
